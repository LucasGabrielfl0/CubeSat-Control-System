...
step(0.5*Gp_s_1,'--m',12)        % Step at 40% Dutycycle (0.4) [Raw model]
step(0.5*Gp_s,'g',12)          % Tuned Model
...
hold on
plot(time_sec, angle,'b');      % Experimental data
step(0.5*Gp_s,12)               % Step in the continuous model
step(0.5*Gp_z, '--r',12)        % Step in the discrete Model
