...
/* Motor Pins */
// Direction
#define IN1_PIN         1   // PIN for Switchs 1 and 4 (Hbridge)
#define IN2_PIN         1   // PIN for Switchs 2 and 3 (Hbridge)
#define IN3_PIN         1   // PIN for Switchs 1 and 4 (Hbridge)
#define IN4_PIN         1   // PIN for Switchs 2 and 3 (Hbridge)
//Speed
...
class MotorControl {
    ...
    void SetReverse();          //
    void Shutdown();            //
    void MotorSetup(uint32_t freq_hz, uint8_t resolution, uint8_t channel);
...
void MotorControl::MotorSetup(uint32_t freq_hz, uint8_t resolution, uint8_t channel){
